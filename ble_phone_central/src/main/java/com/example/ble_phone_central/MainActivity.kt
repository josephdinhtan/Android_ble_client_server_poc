...
class MainActivity : AppCompatActivity() {
        ...
        set(value) {
            ...
            runOnUiThread {
                ...
                if (value != BLELifecycleState.Connected) {
                    activityBinding.textViewSubscription.text = getString(R.string.text_not_subscribed)
                }
            }
        }
    ...
    fun onTapWrite(view: View) {
        ...
        characteristic.value = activityBinding.editTextWriteValue.text.toString().toByteArray(Charsets.UTF_8)
    ...
    private val gattCallback = object : BluetoothGattCallback() {
        ...
        override fun onCharacteristicRead(gatt: BluetoothGatt, characteristic: BluetoothGattCharacteristic, status: Int) {
            if (characteristic.uuid == UUID.fromString(CHAR_FOR_READ_UUID)) {
                ...
                appendLog(log)
                runOnUiThread {
                    activityBinding.textViewReadValue.text = strValue
                }
            } else {
        ...
        override fun onCharacteristicChanged(gatt: BluetoothGatt, characteristic: BluetoothGattCharacteristic) {
            if (characteristic.uuid == UUID.fromString(CHAR_FOR_INDICATE_UUID)) {
                ...
                runOnUiThread {
                    activityBinding.textViewIndicateValue.text = strValue
                }
            } else {
        ...
        override fun onDescriptorWrite(gatt: BluetoothGatt, descriptor: BluetoothGattDescriptor, status: Int) {
            if (descriptor.characteristic.uuid == UUID.fromString(CHAR_FOR_INDICATE_UUID)) {
                if (status == BluetoothGatt.GATT_SUCCESS) {
                    ...
                    runOnUiThread {
                        activityBinding.textViewSubscription.text = subscriptionText
                    }
                } else {
